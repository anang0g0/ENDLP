# Key exchange by semidirect TDP 
## 警告
...
Problem 2.(Triple Decomposition Problem)とは、 
ある$v = x^{-1}a_2x_2$が与えられた時、$ , x1 ∈ H, a ∈ A, x2 ∈ H'.$
（要するに$x1,x2$が冪等元でないこと）
を満たすような$x_1,a,x_2$を求める問題です。

ここでは3分割のうち1つが公開されている、ゆるい条件の問題になっているはずです。
